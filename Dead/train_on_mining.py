...
def run(checkpoint, annotation_dir, image_dir, csv_dir, savedir, num_workers=10, fast_dev_run=False, batch_size=256, gpus=1):
    ...
    trainer = pl.Trainer(logger=comet_logger, gpus=gpus, max_epochs=20, fast_dev_run=fast_dev_run, checkpoint_callback=False)
...
if __name__ == "__main__":
    run(
        checkpoint="/orange/idtrees-collab/DeepTreeAttention/Dead/snapshots/865ac9b23eae45cca33e6a44346c2100.pl",
